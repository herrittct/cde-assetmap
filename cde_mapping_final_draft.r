...
# 
# making static map steps
# get data
# plot data with shape
# titles
# legend
# labels

# All most recent data available

# Get Data
#what data do I need to show NSLP
mapping_profiles %>% 
...
plot(mapping_profiles["nslp_sbp"], main = "Has NSLP & SBP")
plot(mapping_profiles["nslp_sbp_asp"], main = "Has NSLP & SBP & ASP")
plot(mapping_profiles["nslp_sbp_asp_sfsp"], main = "Has NSLP & SBP & ASP & SFSP")
...
# plot(mapping_profiles[])

# Leaflet Map Popups


# Free / Reduced
# paste0("District Name: ", mapping_profiles$sfa_name, "<br>",
#        "Free and Reduced Percent: ", round(mapping_profiles$Scored_eligibility.y, digits = 3), "<br>",
#        "Number of Free Students: ", "<br>",
#        "Number of Reduced Students: ", "<br>",
#        "Percent of Students Receiving Free Benefits: ", "<br>",
#        "Percent of Students Receiving Reduced Price Benefits: ", "<br>",
# 
# )
# CEP Popup
...
# Total Score Popups
mapping_profiles_popups_total_score <- paste0(
        "District Name: ", mapping_profiles$sfa_name, "<br>",
